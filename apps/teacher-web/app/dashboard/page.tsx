    ...
    <div className="relative">
      {!hasSections ? (
        <Card className="p-8 text-center">
          ...
          <Button variant="secondary" className="mt-4 inline-flex items-center gap-2 bg-white border-0" onClick={async () => {
      ...
      <Button variant="secondary" className="fixed right-6 rounded-full px-5 py-3 shadow-soft z-50 inline-flex items-center gap-2 bg-white border-0" style={{ bottom: 'calc(env(safe-area-inset-bottom, 0px) + 1.5rem)' }} onClick={() => setCreateModalOpen(true)}><HiOutlinePlus className="h-5 w-5" /> Create New Section</Button>
