    ...
    <div className="relative">
        ...
        <div className="relative z-10">
          <div className="mx-auto max-w-6xl grid grid-cols-1 lg:grid-cols-2 items-center gap-6 sm:gap-10">
            <div className="text-center lg:text-left">
              ...
              <p className="mt-3 text-slate-600 text-base sm:text-lg">Take attendance in seconds, run polls and word clouds, and get instant insights — at <span className="font-semibold text-slate-900">half the price of Top Hat</span>.</p>
      ...
      <div id="features" className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4">
        ...
        <Card className="p-5">
          ...
          <div className="mt-1 text-slate-600 text-sm">All the essentials of classroom response at about 50% of Top Hat.</div>
        </Card>
      </div>
    </div>
  );
