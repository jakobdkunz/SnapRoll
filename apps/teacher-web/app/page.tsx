    ...
    <div className="relative">
      ...
      <div id="features" className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4">
        ...
        <Card className="p-5">
          ...
          <div className="mt-1 text-slate-600 dark:text-slate-300 text-sm">Run polls, word clouds, and slides in seconds — no extra setup.</div>
        </Card>
        <Card className="p-5">
          <div className="text-lg font-semibold text-slate-900 dark:text-slate-100">Half the price</div>
          <div className="mt-1 text-slate-600 dark:text-slate-300 text-sm">All the essentials of classroom response at about 50% of Top Hat.</div>
        </Card>
      </div>
    </div>
  );
